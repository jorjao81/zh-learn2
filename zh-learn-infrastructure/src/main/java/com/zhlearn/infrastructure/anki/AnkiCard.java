...
/**
 * Represents a raw Anki card as parsed from external TSV format.
 * This is an infrastructure model that represents the external system's data structure.
 * All fields are stored as raw strings without any processing.
 */
public record AnkiCard(
    ...
    /**
     * Creates an AnkiCard with null-safe field assignment.
     * Empty or null fields are converted to empty strings.
     */

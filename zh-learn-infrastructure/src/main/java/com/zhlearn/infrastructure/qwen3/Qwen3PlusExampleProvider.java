...
public class Qwen3PlusExampleProvider implements ExampleProvider {

    private final GenericChatModelProvider<Example> provider;

    public Qwen3PlusExampleProvider() {
        this.provider = new GenericChatModelProvider<>(DashScopeConfig.forExamples("qwen3-plus", "qwen-plus-latest"));
    }
    ...
    @Override
    public String getDescription() { return "Qwen3 Plus (DashScope) example provider"; }

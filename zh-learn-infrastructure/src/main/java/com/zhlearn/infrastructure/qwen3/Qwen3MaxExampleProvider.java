...
public class Qwen3MaxExampleProvider implements ExampleProvider {

    private final GenericChatModelProvider<Example> provider;

    public Qwen3MaxExampleProvider() {
        this.provider = new GenericChatModelProvider<>(DashScopeConfig.forExamples("qwen3-max", "qwen3-max-preview"));
    }
    ...
    @Override
    public String getDescription() { return "Qwen3 Max (DashScope) example provider"; }

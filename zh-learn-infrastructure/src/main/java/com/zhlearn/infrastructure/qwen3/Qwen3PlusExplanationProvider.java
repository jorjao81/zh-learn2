...
public class Qwen3PlusExplanationProvider implements ExplanationProvider {

    private final GenericChatModelProvider<Explanation> provider;

    public Qwen3PlusExplanationProvider() {
        this.provider = new GenericChatModelProvider<>(DashScopeConfig.forExplanation("qwen3-plus", "qwen-plus-latest"));
    }
    ...
    @Override
    public String getDescription() { return "Qwen3 Plus (DashScope) explanation provider"; }

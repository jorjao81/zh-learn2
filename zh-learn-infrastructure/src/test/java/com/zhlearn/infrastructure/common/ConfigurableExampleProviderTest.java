...
class ConfigurableExampleProviderTest {
    ...
    void shouldExposeConfigsWhenConstructedWithProviderConfigs() {
        ProviderConfig<Example> singleConfig = new ProviderConfig<>(
            "api",
            "base",
            "model",
            0.1,
        ...
        ProviderConfig<Example> multiConfig = new ProviderConfig<>(
            "api2",
            "base2",
            "model2",
            0.1,
    ...
    private Example createExample(String marker) {
        Example.Usage usage = new Example.Usage(marker + "句子", marker + "pinyin", "translation", "context", "breakdown");

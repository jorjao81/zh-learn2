...
class TerminalFormatterTest {
    ...
    void shouldPreserveAnsiColorCodesInBoxWithLongColoredText() {
        ...
        String coloredContent =
                "\u001B[36mThis is a very long cyan colored text that should wrap across multiple lines and preserve the cyan color throughout all wrapped lines in the box\u001B[0m";
        ...
        assertThat(coloredLineCount).as("Content should wrap to multiple lines").isGreaterThan(1);
    }
    ...
    void shouldPreserveBoldFormattingInBoxWithLongBoldText() {
        ...
        String boldContent =
                "\u001B[1mThis is a very long bold text that should wrap across multiple lines and preserve the bold formatting throughout all lines in the box\u001B[22m";
    ...
    void shouldPreserveMultipleAnsiFormattingInBox() {
        ...
        String styledContent =
                "\u001B[1m\u001B[36mThis is bold cyan text that is very long and should wrap while preserving both bold and cyan formatting in all lines\u001B[0m";
            ...
            if (line.contains("│") && !line.contains("┌") && !line.contains("└")) {
                ...
                if (firstPipe != -1 && lastPipe != -1 && firstPipe != lastPipe) {
                    ...
                    if (content.trim().length() > 0) {
                        ...
                        assertThat(content)
                                .as(
                                        "All wrapped content lines should preserve both bold and cyan formatting")
                                .contains("\u001B[1m")
                                .contains("\u001B[36m");
                    }
                }
    ...
    void shouldPreserveAnsiFormattingInBoxWithWrappedContent() {
        ...
        String coloredContent =
                "\u001B[33mThis is yellow text that is intentionally very long to force wrapping inside the box and test if the yellow color continues on the next line\u001B[0m";
        ...
        assertThat(contentLineCount).as("Content should wrap to multiple lines").isGreaterThan(1);
            ...
            if (firstPipe != -1 && lastPipe != -1 && firstPipe != lastPipe) {
                ...
                if (!actualContent.isEmpty()) {
                    assertThat(actualContent)
                            .as(
                                    "Content line %d should contain yellow color code",
                                    i - contentStartIndex + 1)
                            .contains("\u001B[33m");
                }
            }
        }

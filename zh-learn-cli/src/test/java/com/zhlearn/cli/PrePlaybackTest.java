...
class PrePlaybackTest {
    ...
    void preprocessesToCachedNormalizedPath() throws Exception {
        ...
        List<PronunciationCandidate> out =
                prePlayback.preprocessCandidates(new Hanzi("学习"), new Pinyin("xuéxí"), List.of(in));
    ...
    void reusesAlreadyCachedFilesWithoutRenaming() throws Exception {
        ...
        PronunciationCandidate in = new PronunciationCandidate("forvo", cached);

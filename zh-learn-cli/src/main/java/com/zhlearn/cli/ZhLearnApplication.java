...
import com.zhlearn.infrastructure.ai.AiProviderFactory;
...
public class ZhLearnApplication {
    ...
    private void printAnalysis(WordAnalysis analysis) {
        ...
        System.out.println("Pinyin: " + analysis.pinyin().toneMarks());
        System.out.println("Romanization: " + analysis.pinyin().romanization());
        System.out.println();
        ...
        System.out.println("Structural Decomposition:");
        for (var component : analysis.structuralDecomposition().components()) {
            System.out.println("  " + component.character() + " - " + component.meaning() + 
                             (component.radical() != null ? " (radical: " + component.radical() + ")" : ""));
        }
        System.out.println();
        ...
        System.out.println("  Etymology: " + analysis.explanation().etymology());
        System.out.println("  Usage: " + analysis.explanation().usage());
        System.out.println("  Similar Words: " + String.join(", ", analysis.explanation().similarWords()));
        if (analysis.explanation().culturalContext() != null) {
            System.out.println("  Cultural Context: " + analysis.explanation().culturalContext());
        }
    }

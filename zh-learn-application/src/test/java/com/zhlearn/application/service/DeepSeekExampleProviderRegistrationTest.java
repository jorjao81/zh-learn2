...
class DeepSeekExampleProviderRegistrationTest {
    ...
    @Test
    void shouldRegisterDeepSeekExampleProviderWhenApiKeyIsAvailable() {
        var providers = registry.getAvailableExampleProviders();
        assertThat(providers).contains("deepseek-chat");
    }
    
    @Test
    void shouldNotRegisterDeepSeekExampleProviderWhenNoApiKey() {
        System.clearProperty("DEEPSEEK_API_KEY");

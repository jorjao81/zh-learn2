...
/**
 * Resolves the Anki media directory based on system properties, environment variables, or
 * reasonable platform defaults.
 */
public class AnkiMediaLocator {
     ...
     * @throws IllegalStateException if a configured media directory path exists but is not a
     *     directory.
     */
